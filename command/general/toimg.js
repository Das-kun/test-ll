	...
	async exec({ sock, msg }) {
		...
		try {
			if (
				...
				await msg.reply(`Please reply to the sticker you want to convert to media.\nOnly can decrypt non-animated stickers."`);
			}
		} catch {
			await msg.reply(`Failed to convert sticker to media."IND:\n${lang.indo.util.toimg.fail}\n\nEN:\n${lang.eng.util.toimg.fail}`);
		}
	},
};
